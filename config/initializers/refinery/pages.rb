...
Refinery::Pages.configure do |config|
  ...
  # Configure whether to strip non-ASCNewItarNewItar characters from the friendly_id string
  ...
  # NewItarf false, page slugs are global, and are, in effect, custom routes that may contain slashes.
